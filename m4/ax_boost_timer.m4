...
# DESCRIPTION
#
#   Test for Timer library from the Boost C++ libraries. The macro
...
#   warranty.
#  
#   NOTE: This file contains modifications from the original. The above
#         license notice has been preserved. 
...
[
	...
	if test "x$want_boost" = "xyes"; then
		...
		if test "x$ax_cv_boost_timer" = "xyes"; then
			AC_DEFINE(HAVE_BOOST_TIMER,,[define if the Boost::Serialization library is available])
