 ...
 */
#ifndef HIER_ENCODING_HPP_
#define HIER_ENCODING_HPP_

#include <boost/serialization/access.hpp>

#include "pique/encoding/index-encoding.hpp"

class HierarchicalIndexEncoding : public IndexEncoding {
public:
	HierarchicalIndexEncoding() : IndexEncoding(Type::HIERARCHICAL) {}
