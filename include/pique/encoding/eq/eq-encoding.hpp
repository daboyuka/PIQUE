 ...
 */
#ifndef EQ_ENCODING_HPP_
#define EQ_ENCODING_HPP_

#include <boost/serialization/access.hpp>

#include "pique/encoding/index-encoding.hpp"

class EqualityIndexEncoding : public IndexEncoding {
public:
	EqualityIndexEncoding() : IndexEncoding(Type::EQUALITY) {}
