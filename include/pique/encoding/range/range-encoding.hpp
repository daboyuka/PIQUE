 ...
 */
#ifndef RANGE_ENCODING_HPP_
#define RANGE_ENCODING_HPP_

#include <boost/serialization/access.hpp>

#include "pique/encoding/index-encoding.hpp"

class RangeIndexEncoding : public IndexEncoding {
public:
	RangeIndexEncoding() : IndexEncoding(Type::RANGE) {}
